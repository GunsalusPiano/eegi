...
class LevelsScoreForm(ScoreForm):
    ...
    ste_relative_score = SingleScoreField(key='STE_REL_LEVEL', required=True, label="Ste rel.:", junk_to_last=True)
    emb_relative_score = SingleScoreField(key='EMB_REL_LEVEL', required=True, label="Emb rel.:", junk_to_last=True)
